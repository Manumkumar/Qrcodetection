...
class QRDetector:
    ...
    def detect_qr_codes(self, frame):
        with self.suppress_warnings():
            ...
            if not codes:
                # Second attempt: preprocess image if nothing found
            ...
            for code in codes:
                ...
                # Deduplication: skip if seen recently
...
def main():
    ...
    try:
        while True:
            ...
            zoom_center = None
            if codes:
                # QR code detected: LOCK zoom (do not update zoom_factor)
                search_mode = False
                ...
                # DO NOT update zoom_factor!
            else:
                # No QR code detected: enable search/zoom logic
